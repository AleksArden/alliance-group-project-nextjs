...
const PrivacyPolicy = () => {
  return (
    <div className={styles.container}>
      ...
      <p className={styles.update}>Last updated: February 05, 2025</p>
      ...
      <h2 className={styles.title}>Interpretation and Definitions</h2>
      ...
      <ul className={styles.list}>
        ...
        <li className={styles.item}>
          <p className={styles.text}>
            ...
            Agreement) refers to Alliance Group LLC, 5 Shevchenko street,
        ...
        <li className={styles.item}>
          <p className={styles.text}>
            <strong>Website</strong> refers to Alliance Group LLC, accessible
            from{' '}
            <a
              className={styles.link}
              href="https://alliancegrouptm.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://alliancegrouptm.com
            </a>
          </p>
        </li>
        <li className={styles.item}>
      ...
      <h2 className={styles.title}>Collecting and Using Your Personal Data</h2>
      <h3 className={styles.subtitle}>Types of Data Collected</h3>
      <h4 className={styles.nameTopic}>Personal Data</h4>
      <p className={styles.text}>
      ...
      <h4 className={styles.nameTopic}>Usage Data</h4>
      <p className={styles.text}>
      ...
      <h4 className={styles.nameTopic}>Tracking Technologies and Cookies</h4>
      <p className={styles.text}>
      ...
      <h3 className={styles.subtitle}>Use of Your Personal Data</h3>
      <p className={styles.text}>
      ...
      <h3 className={styles.subtitle}>Retention of Your Personal Data</h3>
      <p className={styles.text}>
      ...
      <h3 className={styles.subtitle}>Transfer of Your Personal Data</h3>
      <p className={styles.text}>
      ...
      <h3 className={styles.subtitle}>Delete Your Personal Data</h3>
      <p className={styles.text}>
      ...
      <h3 className={styles.subtitle}>Disclosure of Your Personal Data</h3>
      <h4 className={styles.nameTopic}>Business Transactions</h4>
      <p className={styles.text}>
      ...
      <h4 className={styles.nameTopic}>Law enforcement</h4>
      <p className={styles.text}>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className={styles.nameTopic}>Other legal requirements</h4>
      <p className={styles.text}>
        The Company may disclose Your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul className={styles.list}>
        <li className={styles.item}>Comply with a legal obligation</li>
        <li className={styles.item}>
        ...
        <li className={styles.item}>Protect against legal liability</li>
      </ul>
      <h3 className={styles.subtitle}>Security of Your Personal Data</h3>
      <p className={styles.text}>
      ...
      <h2 className={styles.title}>Links to Other Websites</h2>
      <p className={styles.text}>
      ...
      <ul className={styles.list}>
        <li className={styles.item}>
          <p className={styles.text}>By email: alliancegrouptm@ukr.net</p>
        </li>
        <li className={styles.item}>
          <p className={styles.text}>By phone number: +38 063 531 85 39</p>
        </li>
      </ul>
    </div>
  );
